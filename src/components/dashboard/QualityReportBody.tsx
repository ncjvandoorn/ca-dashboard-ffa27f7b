...
interface QualityReportBodyProps {
  report: QualityReport;
  farmName: string;
  createdByName?: string;
}

export const QualityReportBody = forwardRef<HTMLDivElement, QualityReportBodyProps>(
  ({ report, farmName, createdByName }, ref) => {
    ...
    return (
      <div ref={ref} className="p-1 space-y-4">
        {/* Header info bar */}
...
QualityReportBody.displayName = "QualityReportBody";
